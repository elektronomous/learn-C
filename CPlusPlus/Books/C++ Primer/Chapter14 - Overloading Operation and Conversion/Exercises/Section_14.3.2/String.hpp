...
bool operator==(const String &lhs, const String &rhs) {
    /*
        Why we don't just compare the members element ?
        This class act like value, so if it's copy-to or
        assign-to another object, the object being copied
        or assigned is independent then its assigned object.

        So instead of compare the members element which is an
        address, we compare the value of the members of the pointer
