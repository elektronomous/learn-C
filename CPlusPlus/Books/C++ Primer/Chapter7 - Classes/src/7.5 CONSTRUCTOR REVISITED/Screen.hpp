...
class Screen {
    ...
    */
        ...
        */
        ...
        // Note: this code for illustration purposes only and reflects
        // bad practice. It is generally a bad idea to use for a parameter
        // and a member
        void dummy_fcn(pos height) {
            cursor = height * width;        // which height? the parameter
            /*
            If you wanna use the member of this current Object

                cursor = this->height * width;
            
            or

                cursor = Screen::height * width;
            
            = Say that you've defined another variable name with
              height and it's outside of this class Scope
